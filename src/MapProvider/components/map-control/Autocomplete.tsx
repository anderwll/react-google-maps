...
export default function Autocomplete({ onPlaceSelect }: Props) {
  ...
  return (
    <div className="autocomplete-container text-base">
      ...
      {inputValue && (
        <span
          className="bg-white absolute right-[0.5rem] top-[1.82rem] cursor-pointer hover:bg-zinc-200 rounded-full p-1"
      ...
      {predictionResults.length > 0 && (
        <ul className="custom-list w-96 p-3 bg-white rounded-b flex flex-col justify-center items-center">
